...
export const MultiChoices = ({register, errors, remove, field, index}: IMultiChoices) => {
    ...
    <Form.Row>
    <Col xs={10}>
<Form.Control type="text" className="mb-1" isInvalid={errors.propositions && errors.propositions[index]} defaultValue={field.proposition} placeholder="Entrez une proposition" {...register(`propositions.${index}.proposition`)} />
